...
import { FiUpload, FiDownload, FiTrash2, FiFile, FiRefreshCw, FiPlus, FiSearch, FiMessageSquare } from "react-icons/fi"
...
const FileUpload = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            const res = await axios.post(`${baseUrl}/files/upload`, formData, {
                headers: { Authorization: JSON.parse(token).token, "Content-Type": "multipart/form-data", "x-api-key": API_KEY, },
            })
    ...
    const fetchFiles = async () => {
        ...
        try {
            const res = await axios.get(`${baseUrl}/files?userId=${getUserInfo("_id")}`, {
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-6 p-4">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <p className="mt-2 text-md text-gray-600 max-w-md">
                                Seamlessly upload, organize, and manage your PDF documents with ease. Stay productive and keep everything in one place!
                            </p>
                        </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <input id="pdfInput" type="file" accept=".pdf" className="sr-only" onChange={handleFileChange} />
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-end">
                                    <button
                                        ...
                                        disabled={loading}
                                        className={`flex items-center px-4 py-2 rounded-md text-white font-medium ${loading ? "bg-indigo-400" : "bg-indigo-600 hover:bg-indigo-700"
                        ...
                        <div className="px-6 py-8">
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                                ...
                                <div className="flex flex-col sm:flex-row items-start sm:items-center w-full sm:w-auto mt-4 sm:mt-0">
                                    ...
                                    >
                                        <FiRefreshCw className={`mr-2 ${loadingFiles ? "animate-spin" : ""}`} />
                                            ...
                                            {uploadedFiles.map((file) => (
                                                <tr key={file._id} className="hover:bg-gray-50">
                                                    ...
                                                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <button
                                                            onClick={() => handleDownload(file.filename, file.title)}
